...
class MaintenanceScreen extends StatelessWidget {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (equipment.machineType != 'General') ...[
                          Text('Type: ${equipment.machineType}', 
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: Colors.blue,
                            ),
  ...
  void _navigateToEditEquipment(BuildContext context, equipment) {
    Navigator.push(
      context,
      MaterialPageRoute(
  ...
  void _showDeleteConfirmation(BuildContext context, equipment) {
    showDialog(
      context: context,
